...
#ifndef EISCALIBRATION_H
#define EISCALIBRATION_H
...
enum calibration_dataid_e
  {
    ID_DATA_ACC1,
    ID_DATA_GYR1
  };

struct eiscalibration_s
  {
    ...
    uint32_t acclasttimestamp;
    uint32_t gyrlasttimestamp;
  };

struct eiscalibration_s *eiscalibration_create
